...
int main()
{
    ...
    // Exercise 1
    bool has_no_even = std::none_of(my_vector.begin(), my_vector.end(), [](const int val) { return (val % 2); });
    ...
    // Square the values
    std::transform(my_vector.begin(), my_vector.end(), my_result.begin(), [](const auto &val) {
